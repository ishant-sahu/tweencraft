...
class VideoList extends React.Component {
  componentDidMount() {
    ...
    if ($) {
      let videoSlider = new Swiper(`.${type}`, {
        autoplay: {
          delay: 2000,
  ...
  renderSliderContainer() {
    const { stories, heading, type } = this.props;
    return (
      <div className={styles.slider2} id={type}>
          ...
          <div className='row'>
            <div className='col-lg-12'>
              <div className={styles.sliderContainer}>
                <div
                  className={`swiper-container video-slider ${styles.swiperContainer} ${type}`}
                >
