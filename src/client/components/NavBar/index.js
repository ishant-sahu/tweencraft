  ...
  <nav className={`navbar navbar-expand-md navbar-dark ${styles.navbarCustom} fixed-top`}>
    ...
    <div className='navbar-collapse' id='navbarsExampleDefault'>
      <ul className={`navbar-nav ${styles.navbarNav } ml-auto`}>
        <li className={`${styles.navItem} ${styles.displayNone}`} >
          <a className={`${styles.navLink} page-scroll`} href='/'>
            HOME <span className='sr-only'>(current)</span>
          </a>
        </li>
        <li className={`${styles.navItem}`}>
          <a className={`${styles.navLink} page-scroll`} href='/#samples'>
            SAMPLES
          </a>
        </li>
        <li className={`${styles.navItem}`}>
          <a className={`${styles.navLink} page-scroll`} href='/#pricing'>
            PRICING
          </a>
        </li>
        ...
        <li className={styles.navItem}>
          <a className={`${styles.navLink} page-scroll`} href='#how-it-works'>
            HOW IT WORKS
          </a>
        </li>
        <li className={styles.navItem}>
          <a className={`${styles.navLink} page-scroll ${styles.displayNone}`} href='#footer'>
            CONTACT
          </a>
        </li>
      </ul>
